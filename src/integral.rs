...
mod tests {
    ...
    fn test_riemann_integral_2() {
        let f = |x: f64| x.powi(2);
        assert_close(riemann_integral(&f, 0.0, 1.0, 10000000), 1.0 / 3.0, 0.00001);
    }
    ...
    fn test_riemann_integral_3() {
        let f = |x: f64| 1.0 / x;
        assert_close(
            riemann_integral(&f, 1.0, 2.0, 10000000),
            f64::ln(2.0) - f64::ln(1.0),
            0.00001,
        );
    }
    ...
    // fn test_integral_1() {
    //     let f = |x: f64| x.powi(2);
    //     assert_close(integral(&f, 0.0, 1.0), 0.285, 0.000001);
    // }
}
